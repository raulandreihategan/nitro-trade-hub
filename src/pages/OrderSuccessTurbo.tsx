          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 text-center">
            <div className="flex justify-center mb-6">
              <div className="h-20 w-20 rounded-full bg-orange-50 flex items-center justify-center">
                <CheckCircle2 className="h-12 w-12 text-orange-500" strokeWidth={2} />
              </div>
            </div>
            ...
            <div className="border-t border-gray-100 pt-6 mt-2">
              <p className="text-sm text-gray-500 flex items-center justify-center gap-2">
                ...
                If you don't receive the email within 4 hours, contact support@turbobit.net
              </p>
            </div>
          </div>
        )}
...
export default OrderSuccessTurbo;
